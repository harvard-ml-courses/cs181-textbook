...
\readernote{Each eigenvector is a principle component. The larger the eigenvalue associated with that principle component, the more variance there is along that principle component.}

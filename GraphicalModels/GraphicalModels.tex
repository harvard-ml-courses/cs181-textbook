...
\readernote{Notice that the number of parameters we need is $(2^2 * 4^2 * 8^2 * 16^2) - 1$ and not $(2^2 * 4^2 * 8^2 * 16^2)$. This is simply because if we know the first $(2^2 * 4^2 * 8^2 * 16^2) - 1$ parameters, we can calculate the value of the final one exactly.}
